        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-3xl font-bold">iDental</span>
            </div>
            <div className="flex items-center gap-2">
      ...
      <section className="px-4 py-8">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between gap-4 mb-5">
            <div>
              <h2 className="text-xl font-semibold">Clínicas dentales relevantes</h2>
              <p className="text-sm text-muted-foreground">
                Primero aparecen las clínicas dentales en {selectedCity}.
              </p>
            </div>
          ...
          {shops.length === 0 ? (
            <div className="rounded-xl border p-8 text-center text-muted-foreground">
              Todavía no hay clínicas dentales activas en esta zona.
            </div>
          ) : (
              ...
              {shops.map((shop) => (
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground line-clamp-2">
                    {shop.description || shop.address || "Agenda abierta para limpiezas, valoraciones y procedimientos."}
                  </p>
                </Link>
              ))}
            </div>
