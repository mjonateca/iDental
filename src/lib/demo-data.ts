...
export const demoShop: Shop = {
  ...
  slug: "sonrisa-clara",
  logo_url: null,
  banner_url: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?auto=format&fit=crop&w=1600&q=80",
  maps_url: null,
...
export const demoBookings: (Booking & {
  ...
  {
    id: "bk-1", client_id: "demo-client-1", client_name: null, client_phone: null, notes: "Primera limpieza del semestre", barber_id: "demo-barber-1",
    ...
    payment_status: "pending", payment_required: false, payment_amount: 1800, payment_currency: "DOP", paid_at: null, confirmed_at: null, confirmed_by_user_id: null,
  ...
  {
    id: "bk-2", client_id: "demo-client-2", client_name: null, client_phone: null, notes: "Pareja consulta inicial", barber_id: "demo-barber-2",
    shop_id: "demo-shop-1", service_id: "svc-2",
    date: today, start_time: "10:00:00", end_time: "10:45:00",
    status: "confirmed", deposit_status: "none", deposit_amount: 0,
    payment_status: "paid", payment_required: false, payment_amount: 2100, payment_currency: "DOP", paid_at: new Date().toISOString(), confirmed_at: null, confirmed_by_user_id: null,
    whatsapp_reminder_sent: false, created_at: new Date().toISOString(),
  ...
  },
  {
    ...
    payment_status: "paid", payment_required: false, payment_amount: 4200, payment_currency: "DOP", paid_at: new Date().toISOString(), confirmed_at: null, confirmed_by_user_id: null,
  ...
  {
    id: "bk-4", client_id: "demo-client-4", client_name: null, client_phone: null, notes: "Paciente pediatrico", barber_id: "demo-barber-2",
    shop_id: "demo-shop-1", service_id: "svc-4",
    date: today, start_time: "14:00:00", end_time: "14:25:00",
    status: "confirmed", deposit_status: "none", deposit_amount: 0,
    payment_status: "failed", payment_required: false, payment_amount: 1500, payment_currency: "DOP", paid_at: null, confirmed_at: null, confirmed_by_user_id: null,
    whatsapp_reminder_sent: false, created_at: new Date().toISOString(),
