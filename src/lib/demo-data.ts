...
export const demoShop: Shop = {
  ...
  city: "Santiago",
  description: "Clínica dental demo para probar reservas, profesionales y servicios.",
  is_active: true,
...
export const demoBarbers: Barber[] = [
  {
    ...
    avatar_url: null,
    bio: "10 años de experiencia, especializada en odontología general y estética dental.",
    portfolio_urls: [],
    rating: 4.8,
  ...
  },
  {
    ...
    avatar_url: null,
    bio: "Especialista en ortodoncia y rehabilitación oral.",
    portfolio_urls: [],
    rating: 4.6,
    is_independent: false,
...
export const demoServices: Service[] = [
  { id: "svc-1", shop_id: "demo-shop-1", name: "Limpieza dental", duration_min: 30, price: 350, currency: "DOP", is_active: true, description: "Profilaxis y revisión rápida.", category: "Higiene", is_visible: true, sort_order: 1, created_at: new Date().toISOString() },
  { id: "svc-2", shop_id: "demo-shop-1", name: "Valoración general", duration_min: 45, price: 550, currency: "DOP", is_active: true, description: "Evaluación completa con plan de tratamiento.", category: "Diagnóstico", is_visible: true, sort_order: 2, created_at: new Date().toISOString() },
  { id: "svc-3", shop_id: "demo-shop-1", name: "Blanqueamiento", duration_min: 20, price: 300, currency: "DOP", is_active: true, description: "Sesión rápida para mejorar el tono dental.", category: "Estética", is_visible: true, sort_order: 3, created_at: new Date().toISOString() },
  { id: "svc-4", shop_id: "demo-shop-1", name: "Consulta infantil", duration_min: 25, price: 300, currency: "DOP", is_active: true, description: "Atención preventiva para niños.", category: "Pediatría", is_visible: true, sort_order: 4, created_at: new Date().toISOString() },
];
...
export const demoBookings: (Booking & {
...
})[] = [
  {
    ...
    barbers: { display_name: "Dra. Laura Gómez" },
    services: { name: "Limpieza dental", duration_min: 30, price: 350 },
  },
  {
    ...
    barbers: { display_name: "Dr. Miguel Torres" },
    services: { name: "Valoración general", duration_min: 45, price: 550 },
  },
  {
    ...
    barbers: { display_name: "Dra. Laura Gómez" },
    services: { name: "Blanqueamiento", duration_min: 20, price: 300 },
  },
  {
    ...
    barbers: { display_name: "Dr. Miguel Torres" },
    services: { name: "Consulta infantil", duration_min: 25, price: 300 },
  },
];
